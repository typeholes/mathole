      ...
      <Swap :swap="hasToggle('loggedIn')">
         <template #before>
            <Swap :swap="hasToggle('freeAccount')">
               <template #before>
                  <div class="blink_me">
                     Your account has been disabled due to automatic payments
                     being declined
                  </div>
                  <input type="text" /><button @click="shout()">
                     Update Credit Card
                  </button>
         ...
         <template #after> freebee </template>
      </Swap>
...
<style scoped>
   ...
   @keyframes glow {
      from {
         text-shadow: 0 0 1px #fff, 0 0 2px #fff, 0 0 2px #e60073,
            0 0 2px #e60073, 0 0 2px #e60073, 0 0 2px #e60073, 0 0 2px #e60073;
      }
      to {
         text-shadow: 0 0 4px #fff, 0 0 10px #ff4da6, 0 0 10px #ff4da6,
